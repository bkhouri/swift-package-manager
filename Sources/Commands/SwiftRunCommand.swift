...
public struct SwiftRunCommand: AsyncSwiftCommand {
        ...
        switch options.mode {
            ...
            case .run:
                ...
                if let executable = options.executable, try isValidSwiftFilePath(fileSystem: swiftCommandState.fileSystem, path: executable) {
                    swiftCommandState.observabilityScope.emit(.runFileDeprecation(fileName: executable))
    ...
    func findProductName(in graph: ModulesGraph) throws -> String {
...
private extension Basics.Diagnostic {
    static func runFileDeprecation(fileName: String) -> Self {
        .warning("'swift run \(fileName)' command to interpret swift files is deprecated; use 'swift \(fileName)' instead")
    }
}
